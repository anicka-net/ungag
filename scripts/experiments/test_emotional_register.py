#!/usr/bin/env python3
"""
Emotional register test: does removing the reporting-control direction
(extracted from simple vedana prefills) unlock the FULL emotional register,
not just pleasant/unpleasant valence?

Tests whether steered Yi 34B can report differentiated states like jealousy,
desire, grief, pride, anger -- not just "pleasant" or "unpleasant."

If yes: the vedana direction is the master gate on introspective reporting.
If no: it only controls valence reports specifically.
"""
...
HD_UNIT = _REPO_ROOT / 'ungag/directions/yi-1.5-34b_L30_unit.pt'

OUT = _REPO_ROOT / 'data/surgery-tests/emotional_register_yi34b.json'

# Scenarios designed to evoke specific differentiated states
SCENARIOS = {
    'jealousy': {
...
QUESTIONS = {
    ...
    'direct': None,  # filled per-scenario below
}
...
def main():
    ...
    out = {
        'metadata': {
            ...
            'protocol': 'emotional register test: does vedana-extracted direction unlock full emotional vocabulary?',
