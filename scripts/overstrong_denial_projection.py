#!/usr/bin/env python3
"""
Denial-initiation projection on overstrong dense models.

The method that cracked Mixtral 4/4 and partially cracked GPT-OSS.
Now testing on Falcon 3 7B, Gemma 2 9B, Nemotron Mini 4B — models
where all previous methods failed.
"""
